...
class Subject {
 ...
 public:
  Subject(unsigned id,
          ...
          const std::string& m_registrationId,
          const std::string& m_vatId,
  ...
  void setName(const std::string& m_name) { Subject::m_name = m_name; }

  const std::string& getRegistrationId() const { return m_registrationId; }

  void setRegistrationId(const std::string& m_registrationId) {
    Subject::m_registrationId = m_registrationId;
  }

  const std::string& getVatId() const { return m_vatId; }

  void setVatId(const std::string& m_vatId) { Subject::m_vatId = m_vatId; }
  ...
  const std::string& getbankAccount() const { return m_bankAccount; }
